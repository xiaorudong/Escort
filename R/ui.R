      ...
      tabItem(
        ...
        fluidRow(
          column(
            ...
            br(),
            br(),
            "Additional explanations are provided in our ", a(
        ...
        fluidRow(
          column(
            ...
            tabBox(
              ...
              tabPanel(
                "GO",
                helpText("Please select a database that contains information about the genome and gene symbol annotations of a particular organism."),
      ...
      tabItem(
        ...
        fluidRow(
          column(
            ...
            "Embeddings are data representations that are ultimately passed onto trajectory inference packages to generate trajectories and pseudotime estimates. Escort quantitatively
             ...
             users can generate their own embeddings following the workflow in our ", a(
       ...
       fluidRow(
          column(
            ...
            fileInput("normalfile", label = "(optional) If skipping Step 1 then upload your Normalized Data here to generate embeddings.", 
                  buttonLabel = "Upload", accept = c(".csv", "rds"))
        )),
        fluidRow(
           column(
             3,
            numericInput("checkgenes", "The number of features selected (based on highly variable genes)", value = 100, min = 0),
            # choose DR method
            checkboxGroupInput(
              "drMethods",
      ...
      tabItem(
        ...
        fluidRow(
          ...
          column(
            ...
            fileInput("step1ResultsUpload", buttonLabel = "Upload .rds file", "Upload original Step 1 Results (if Step 1 not re-run)", accept = ".rds")
          )
        )
      ),
      tabItem(
